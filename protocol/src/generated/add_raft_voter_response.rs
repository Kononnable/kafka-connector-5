...
impl ApiResponse for AddRaftVoterResponse {
    type Request = crate::generated::AddRaftVoterRequest;
...
impl KafkaSerialize for AddRaftVoterResponse {
...
impl KafkaDeserialize for AddRaftVoterResponse {
