...
impl ApiRequest for DescribeDelegationTokenRequest {
    ...
    fn deserialize(version: ApiVer, buf: &mut Bytes) -> Result<Self, SerializationError> {
        let is_flexible = version.0 >= Self::get_min_flexible_version().0;
        let owners = KafkaCodec::decode(buf, version, is_flexible)?;
        if is_flexible {
...
impl KafkaCodec for DescribeDelegationTokenRequest {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for DescribeDelegationTokenOwner {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
