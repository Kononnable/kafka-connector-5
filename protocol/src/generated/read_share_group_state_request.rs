...
impl ApiRequest for ReadShareGroupStateRequest {
    type Response = crate::generated::ReadShareGroupStateResponse;
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let topics = <Vec<ReadStateData> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode Topics"))?;
        Ok(Self { group_id, topics })
    }
}
impl KafkaSerialize for ReadShareGroupStateRequest {
...
impl KafkaDeserialize for ReadShareGroupStateRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let topics = <Vec<ReadStateData> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        Ok(Self { group_id, topics })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let topics = <Vec<ReadStateData> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaDeserialize for PartitionData {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        Ok(Self { partition, leader_epoch })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
...
impl KafkaSerialize for ReadStateData {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
...
impl KafkaDeserialize for ReadStateData {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
