...
impl ApiResponse for OffsetDeleteResponse {
    ...
    fn deserialize(
        ...
        let topics =
            <Vec<OffsetDeleteResponseTopic> as KafkaDeserialize>::decode(buf, version, is_flexible)
...
impl KafkaDeserialize for OffsetDeleteResponseTopic {
    fn decode<B: Buf>(
        ...
        let partitions = <Vec<OffsetDeleteResponsePartition> as KafkaDeserialize>::decode(
            buf,
            version,
            is_flexible,
        )
