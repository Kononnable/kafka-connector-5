...
impl ApiResponse for ListConfigResourcesResponse {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(74) }
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        self.config_resources.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ConfigResources"))?;
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let config_resources = <Vec<ConfigResource> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ConfigResources"))?;
        Ok(Self { throttle_time_ms, error_code, config_resources })
    }
}
impl KafkaSerialize for ListConfigResourcesResponse {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.config_resources.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ConfigResources".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.config_resources.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ConfigResources".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for ListConfigResourcesResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let config_resources = <Vec<ConfigResource> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ConfigResources".into() })?;
        Ok(Self { throttle_time_ms, error_code, config_resources })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let config_resources = <Vec<ConfigResource> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ConfigResources".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaDeserialize for ConfigResource {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        Ok(Self { resource_name, resource_type })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
