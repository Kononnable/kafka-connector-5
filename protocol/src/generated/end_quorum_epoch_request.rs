...
impl ApiRequest for EndQuorumEpochRequest {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(54) }
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        if (1) <= version.0 {
            self.leader_endpoints.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode LeaderEndpoints"))?;
        }
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let leader_endpoints = if (1) <= version.0 {
            <Vec<LeaderEndpoint> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode LeaderEndpoints"))?
        } else {
            Default::default()
        };
        Ok(Self { cluster_id, topics, leader_endpoints })
    }
}
impl KafkaSerialize for EndQuorumEpochRequest {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.leader_endpoints.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode LeaderEndpoints".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.leader_endpoints.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode LeaderEndpoints".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for EndQuorumEpochRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let leader_endpoints = <Vec<LeaderEndpoint> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode LeaderEndpoints".into() })?;
        Ok(Self { cluster_id, topics, leader_endpoints })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let leader_endpoints = <Vec<LeaderEndpoint> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode LeaderEndpoints".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaSerialize for PartitionData {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.preferred_successors.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PreferredSuccessors".into() })?;
        self.preferred_candidates.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PreferredCandidates".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.preferred_successors.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PreferredSuccessors".into() })?;
        self.preferred_candidates.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PreferredCandidates".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for PartitionData {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let preferred_successors = <Vec<i32> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode PreferredSuccessors".into() })?;
        let preferred_candidates = <Vec<ReplicaInfo> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode PreferredCandidates".into() })?;
        Ok(Self { partition_index, leader_id, leader_epoch, preferred_successors, preferred_candidates })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let preferred_successors = <Vec<i32> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode PreferredSuccessors".into() })?;
        let preferred_candidates = <Vec<ReplicaInfo> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode PreferredCandidates".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
...
impl KafkaSerialize for ReplicaInfo {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        self.candidate_id.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode CandidateId".into() })?;
        self.candidate_directory_id.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode CandidateDirectoryId".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        self.candidate_id.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode CandidateId".into() })?;
        self.candidate_directory_id.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode CandidateDirectoryId".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for ReplicaInfo {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        let candidate_id = <i32 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode CandidateId".into() })?;
        let candidate_directory_id = <[u8; 16] as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode CandidateDirectoryId".into() })?;
        Ok(Self { candidate_id, candidate_directory_id })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        let candidate_id = <i32 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode CandidateId".into() })?;
        let candidate_directory_id = <[u8; 16] as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode CandidateDirectoryId".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
