...
impl ApiRequest for DeleteTopicsRequest {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(20) }
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        assert!((1) <= version.0 && version.0 <= (6), "version {} is not supported by {} (supported: 1-6)", version.0, stringify!(Self));
        ...
        if (0) <= version.0 && version.0 <= (5) {
            self.topic_names.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode TopicNames"))?;
        }
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let topics = if (6) <= version.0 {
            <Vec<DeleteTopicState> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode Topics"))?
        } else {
            Default::default()
        };
        let topic_names = if (0) <= version.0 && version.0 <= (5) {
            <Vec<String> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode TopicNames"))?
        } else {
            Default::default()
        };
        ...
        Ok(Self { topics, topic_names, timeout_ms })
    }
}
impl KafkaSerialize for DeleteTopicsRequest {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.topic_names.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TopicNames".into() })?;
    ...
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.topic_names.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TopicNames".into() })?;
...
impl KafkaDeserialize for DeleteTopicsRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        let topics = <Vec<DeleteTopicState> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        let topic_names = <Vec<String> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode TopicNames".into() })?;
    ...
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        let topics = <Vec<DeleteTopicState> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        let topic_names = <Vec<String> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode TopicNames".into() })?;
