...
impl ApiResponse for ControllerRegistrationResponse {
    type Request = crate::generated::ControllerRegistrationRequest;
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        Ok(Self { throttle_time_ms, error_code, error_message })
    }
}
impl KafkaSerialize for ControllerRegistrationResponse {
...
impl KafkaDeserialize for ControllerRegistrationResponse {
