...
pub struct OffsetDeleteRequest {
    ...
    pub topics: IndexMap<String, OffsetDeleteRequestTopic>,
}
...
impl KafkaCodec for OffsetDeleteRequest {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for OffsetDeleteRequestPartition {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for OffsetDeleteRequestTopic {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
