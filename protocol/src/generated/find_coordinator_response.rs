...
impl ApiResponse for FindCoordinatorResponse {
    ...
    fn deserialize(
        ...
        let node_id = <i32 as KafkaDeserialize>::decode_flexible(buf, is_flexible)
            .map_err(|_| SerializationError::Decode("failed to decode NodeId"))?;
        let host = <String as KafkaDeserialize>::decode_flexible(buf, is_flexible)
            .map_err(|_| SerializationError::Decode("failed to decode Host"))?;
        let port = <i32 as KafkaDeserialize>::decode_flexible(buf, is_flexible)
