...
impl ApiRequest for AlterReplicaLogDirsRequest {
    ...
    fn deserialize(version: ApiVer, buf: &mut Bytes) -> Result<Self, SerializationError> {
        let is_flexible = version.0 >= Self::get_min_flexible_version().0;
        let dirs = KafkaCodec::decode(buf, version, is_flexible)?;
        if is_flexible {
...
impl KafkaCodec for AlterReplicaLogDirsRequest {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for AlterReplicaLogDir {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for AlterReplicaLogDirTopic {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
