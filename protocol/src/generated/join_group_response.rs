...
impl ApiResponse for JoinGroupResponse {
    ...
    fn deserialize(
        ...
        let leader = <String as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
        ...
        let members = <Vec<JoinGroupResponseMember> as KafkaDeserialize>::decode_flexible(
            buf,
            version,
            is_flexible,
        )
...
impl KafkaDeserialize for JoinGroupResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        tracing::trace!(
            "  [{}] classic decode field `Leader` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let leader =
        ...
        tracing::trace!(
            "  [{}] classic decode field `SkipAssignment` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let skip_assignment =
    ...
    fn decode_flexible<B: Buf>(
        ...
        tracing::trace!(
            "  [{}] decoding field `Leader` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let leader = <String as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
        ...
        tracing::trace!(
            "  [{}] decoding field `SkipAssignment` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let skip_assignment = if (9) <= version.0 {
