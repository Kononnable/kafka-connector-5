...
impl ApiResponse for EndQuorumEpochResponse {
    type Request = crate::generated::EndQuorumEpochRequest;
...
impl KafkaSerialize for EndQuorumEpochResponse {
...
impl KafkaDeserialize for EndQuorumEpochResponse {
...
impl KafkaDeserialize for PartitionData {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        Ok(Self { partition_index, error_code, leader_id, leader_epoch })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
