...
impl ApiRequest for AlterPartitionReassignmentsRequest {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(45) }
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        if (1) <= version.0 {
            self.allow_replication_factor_change.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode AllowReplicationFactorChange"))?;
        }
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let allow_replication_factor_change = if (1) <= version.0 {
            <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode AllowReplicationFactorChange"))?
        } else {
            Default::default()
        };
        let topics = <Vec<ReassignableTopic> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode Topics"))?;
        Ok(Self { timeout_ms, allow_replication_factor_change, topics })
    }
}
impl KafkaSerialize for AlterPartitionReassignmentsRequest {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.allow_replication_factor_change.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode AllowReplicationFactorChange".into() })?;
    ...
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.allow_replication_factor_change.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode AllowReplicationFactorChange".into() })?;
...
impl KafkaDeserialize for AlterPartitionReassignmentsRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let allow_replication_factor_change = <bool as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode AllowReplicationFactorChange".into() })?;
        let topics = <Vec<ReassignableTopic> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        Ok(Self { timeout_ms, allow_replication_factor_change, topics })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let allow_replication_factor_change = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode AllowReplicationFactorChange".into() })?;
        let topics = <Vec<ReassignableTopic> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        if is_flexible {
            // Tagged fields (skip)
    ...
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        if is_flexible {
            if let Some(ref __val) = self.replicas {
                ...
                __val.encode_flexible(buf, true).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode Replicas".into() })?;
            } else {
                crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
            }
        } else {
            if let Some(ref __val) = self.replicas {
                __val.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode Replicas".into() })?;
            }
        }
        if is_flexible {
            // Tagged fields (none yet)
...
impl KafkaDeserialize for ReassignablePartition {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let replicas = <Option<Vec<i32>> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Replicas".into() })?;
        Ok(Self { partition_index, replicas })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let replicas = if is_flexible {
            ...
            if __present == 0 {
                ...
                Some(<Vec<i32> as KafkaDeserialize>::decode_flexible(buf, true).map_err(|_| DecodeError::Protocol { message: "failed to decode Replicas".into() })?)
            }
        } else {
            <Option<Vec<i32>> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Replicas".into() })?
        };
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
...
impl KafkaDeserialize for ReassignableTopic {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let partitions = <Vec<ReassignablePartition> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Partitions".into() })?;
    ...
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let partitions = <Vec<ReassignablePartition> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Partitions".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
