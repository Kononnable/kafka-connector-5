...
impl KafkaSerialize for SnapshotHeaderRecord {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaDeserialize for SnapshotHeaderRecord {
    fn decode<B: Buf>(
        buf: &mut B,
        version: ApiVer,
        is_flexible: bool,
        ...
        let last_contained_log_timestamp = KafkaDeserialize::decode(buf, version, is_flexible)?;
        if is_flexible {
