...
impl ApiResponse for SaslAuthenticateResponse {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(36) }
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        self.auth_bytes.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode AuthBytes"))?;
        if (1) <= version.0 {
            self.session_lifetime_ms.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode SessionLifetimeMs"))?;
        }
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let auth_bytes = <Vec<u8> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode AuthBytes"))?;
        let session_lifetime_ms = if (1) <= version.0 {
            <i64 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode SessionLifetimeMs"))?
        } else {
            Default::default()
        };
        Ok(Self { error_code, error_message, auth_bytes, session_lifetime_ms })
    }
}
impl KafkaSerialize for SaslAuthenticateResponse {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.auth_bytes.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode AuthBytes".into() })?;
        self.session_lifetime_ms.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode SessionLifetimeMs".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.auth_bytes.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode AuthBytes".into() })?;
        self.session_lifetime_ms.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode SessionLifetimeMs".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for SaslAuthenticateResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let auth_bytes = <Vec<u8> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode AuthBytes".into() })?;
        let session_lifetime_ms = <i64 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode SessionLifetimeMs".into() })?;
        Ok(Self { error_code, error_message, auth_bytes, session_lifetime_ms })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let auth_bytes = <Vec<u8> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode AuthBytes".into() })?;
        let session_lifetime_ms = <i64 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode SessionLifetimeMs".into() })?;
        if is_flexible {
            // Tagged fields (skip)
