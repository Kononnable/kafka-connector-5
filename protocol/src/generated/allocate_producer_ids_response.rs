...
impl ApiResponse for AllocateProducerIdsResponse {
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        self.producer_id_start.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ProducerIdStart"))?;
        self.producer_id_len.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ProducerIdLen"))?;
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let producer_id_start = <i64 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ProducerIdStart"))?;
        let producer_id_len = <i32 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ProducerIdLen"))?;
        Ok(Self { throttle_time_ms, error_code, producer_id_start, producer_id_len })
    }
}
impl KafkaSerialize for AllocateProducerIdsResponse {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.producer_id_start.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ProducerIdStart".into() })?;
        self.producer_id_len.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ProducerIdLen".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.producer_id_start.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ProducerIdStart".into() })?;
        self.producer_id_len.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ProducerIdLen".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for AllocateProducerIdsResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let producer_id_start = <i64 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ProducerIdStart".into() })?;
        let producer_id_len = <i32 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ProducerIdLen".into() })?;
        Ok(Self { throttle_time_ms, error_code, producer_id_start, producer_id_len })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let producer_id_start = <i64 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ProducerIdStart".into() })?;
        let producer_id_len = <i32 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ProducerIdLen".into() })?;
        if is_flexible {
            // Tagged fields (skip)
