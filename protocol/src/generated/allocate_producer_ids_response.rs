...
impl ApiResponse for AllocateProducerIdsResponse {
    ...
    fn deserialize(version: ApiVer, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let producer_id_start = KafkaCodec::decode(buf, version, is_flexible)?;
        let producer_id_len = KafkaCodec::decode(buf, version, is_flexible)?;
        if is_flexible {
...
impl KafkaCodec for AllocateProducerIdsResponse {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
