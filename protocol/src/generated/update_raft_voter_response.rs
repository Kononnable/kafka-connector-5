...
impl ApiResponse for UpdateRaftVoterResponse {
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        self.current_leader.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode CurrentLeader"))?;
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let current_leader = <CurrentLeader as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode CurrentLeader"))?;
        Ok(Self { throttle_time_ms, error_code, current_leader })
    }
}
...
impl KafkaDeserialize for UpdateRaftVoterResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let current_leader = <CurrentLeader as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode CurrentLeader".into() })?;
        Ok(Self { throttle_time_ms, error_code, current_leader })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let current_leader = <CurrentLeader as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode CurrentLeader".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaDeserialize for CurrentLeader {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        Ok(Self { leader_id, leader_epoch, host, port })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
