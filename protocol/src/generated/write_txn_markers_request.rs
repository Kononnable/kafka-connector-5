...
impl ApiRequest for WriteTxnMarkersRequest {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        let is_flexible = (1) <= version.0;
        let markers = <Vec<WritableTxnMarker> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode Markers"))?;
        Ok(Self { markers })
    }
}
...
impl KafkaDeserialize for WriteTxnMarkersRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        let markers = <Vec<WritableTxnMarker> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Markers".into() })?;
        Ok(Self { markers })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        let markers = <Vec<WritableTxnMarker> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Markers".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaSerialize for WritableTxnMarker {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.transaction_result.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TransactionResult".into() })?;
    ...
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.transaction_result.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TransactionResult".into() })?;
...
impl KafkaDeserialize for WritableTxnMarker {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let transaction_result = <bool as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode TransactionResult".into() })?;
        let topics = <Vec<WritableTxnMarkerTopic> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
        ...
        Ok(Self { producer_id, producer_epoch, transaction_result, topics, coordinator_epoch })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let transaction_result = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode TransactionResult".into() })?;
        let topics = <Vec<WritableTxnMarkerTopic> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Topics".into() })?;
