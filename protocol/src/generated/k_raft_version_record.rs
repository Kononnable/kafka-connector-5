...
impl KafkaSerialize for KRaftVersionRecord {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaDeserialize for KRaftVersionRecord {
    fn decode<B: Buf>(
        buf: &mut B,
        version: ApiVer,
        is_flexible: bool,
        ...
        let kraft_version = KafkaDeserialize::decode(buf, version, is_flexible)?;
        if is_flexible {
