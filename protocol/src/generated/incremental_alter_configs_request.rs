...
impl ApiRequest for IncrementalAlterConfigsRequest {
    ...
    fn get_api_key() -> ApiKey { ApiKey::new(44) }
...
impl KafkaSerialize for AlterableConfig {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.config_operation.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ConfigOperation".into() })?;
    ...
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.config_operation.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ConfigOperation".into() })?;
        if is_flexible {
...
impl KafkaDeserialize for AlterableConfig {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let config_operation = <i8 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ConfigOperation".into() })?;
        ...
        Ok(Self { name, config_operation, value })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let config_operation = <i8 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ConfigOperation".into() })?;
