...
impl ApiResponse for DescribeDelegationTokenResponse {
    ...
    fn deserialize(
        ...
        let tokens = <Vec<DescribedDelegationToken> as KafkaDeserialize>::decode_flexible(
            buf,
            version,
            is_flexible,
        )
...
impl KafkaDeserialize for DescribedDelegationToken {
    ...
    fn decode_flexible<B: Buf>(
        ...
        let issue_timestamp = <i64 as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
            .map_err(|_| DecodeError::Protocol {
                message: "failed to decode IssueTimestamp".into(),
            })?;
        tracing::trace!(
        ...
        let max_timestamp = <i64 as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
            .map_err(|_| DecodeError::Protocol {
            message: "failed to decode MaxTimestamp".into(),
        })?;
        tracing::trace!(
