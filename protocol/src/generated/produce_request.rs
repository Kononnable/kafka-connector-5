...
impl ApiRequest for ProduceRequest {
    ...
    fn deserialize(version: ApiVer, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let topic_data = KafkaCodec::decode(buf, version, is_flexible)?;
        if is_flexible {
...
impl KafkaCodec for ProduceRequest {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for PartitionProduceData {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for TopicProduceData {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
