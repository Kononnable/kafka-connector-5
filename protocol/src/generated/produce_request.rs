...
impl ApiRequest for ProduceRequest {
    ...
    fn deserialize(
        ...
        let acks = <i16 as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
        ...
        let topic_data =
            <Vec<TopicProduceData> as KafkaDeserialize>::decode_flexible(buf, version, is_flexible)
...
impl KafkaDeserialize for ProduceRequest {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        tracing::trace!(
            "  [{}] classic decode field `Acks` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        ...
        tracing::trace!(
            "  [{}] classic decode field `TopicData` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let topic_data =
    ...
    fn decode_flexible<B: Buf>(
        ...
        tracing::trace!(
            "  [{}] decoding field `Acks` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let acks = <i16 as KafkaDeserialize>::decode_flexible(buf, version, is_flexible).map_err(
            |_| DecodeError::Protocol {
                message: "failed to decode Acks".into(),
            },
        )?;
        ...
        tracing::trace!(
            "  [{}] decoding field `TopicData` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let topic_data =
...
impl KafkaDeserialize for TopicProduceData {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        tracing::trace!(
            "  [{}] classic decode field `PartitionData` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let partition_data =
    ...
    fn decode_flexible<B: Buf>(
        ...
        tracing::trace!(
            "  [{}] decoding field `PartitionData` ({} bytes remaining)",
            stringify!(Self),
            buf.remaining()
        );
        let partition_data = <Vec<PartitionProduceData> as KafkaDeserialize>::decode_flexible(
            buf,
            version,
            is_flexible,
        )
