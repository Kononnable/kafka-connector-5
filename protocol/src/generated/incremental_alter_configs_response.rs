...
impl ApiResponse for IncrementalAlterConfigsResponse {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let responses = <Vec<AlterConfigsResourceResponse> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode Responses"))?;
...
impl KafkaDeserialize for IncrementalAlterConfigsResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let responses = <Vec<AlterConfigsResourceResponse> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode Responses".into() })?;
        Ok(Self { throttle_time_ms, responses })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let responses = <Vec<AlterConfigsResourceResponse> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode Responses".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaDeserialize for AlterConfigsResourceResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        Ok(Self { error_code, error_message, resource_type, resource_name })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
