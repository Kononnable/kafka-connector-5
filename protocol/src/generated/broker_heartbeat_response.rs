...
impl ApiResponse for BrokerHeartbeatResponse {
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        self.is_caught_up.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode IsCaughtUp"))?;
        self.is_fenced.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode IsFenced"))?;
        self.should_shut_down.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ShouldShutDown"))?;
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let is_caught_up = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode IsCaughtUp"))?;
        let is_fenced = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode IsFenced"))?;
        let should_shut_down = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ShouldShutDown"))?;
        Ok(Self { throttle_time_ms, error_code, is_caught_up, is_fenced, should_shut_down })
    }
}
impl KafkaSerialize for BrokerHeartbeatResponse {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.is_caught_up.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode IsCaughtUp".into() })?;
        self.is_fenced.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode IsFenced".into() })?;
        self.should_shut_down.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ShouldShutDown".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.is_caught_up.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode IsCaughtUp".into() })?;
        ...
        self.should_shut_down.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ShouldShutDown".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for BrokerHeartbeatResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let is_caught_up = <bool as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode IsCaughtUp".into() })?;
        let is_fenced = <bool as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode IsFenced".into() })?;
        let should_shut_down = <bool as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ShouldShutDown".into() })?;
        Ok(Self { throttle_time_ms, error_code, is_caught_up, is_fenced, should_shut_down })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let is_caught_up = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode IsCaughtUp".into() })?;
        ...
        let should_shut_down = <bool as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ShouldShutDown".into() })?;
        if is_flexible {
            // Tagged fields (skip)
