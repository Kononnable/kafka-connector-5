...
impl ApiResponse for AddPartitionsToTxnResponse {
    ...
    fn serialize(&self, version: crate::traits::ApiVersion, buf: &mut BytesMut) -> Result<(), SerializationError> {
        ...
        if (4) <= version.0 {
            self.results_by_transaction.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ResultsByTransaction"))?;
        }
        if (0) <= version.0 && version.0 <= (3) {
            self.results_by_topic_v3_and_below.encode_flexible(buf, is_flexible).map_err(|_| SerializationError::Encode("failed to encode ResultsByTopicV3AndBelow"))?;
        }
        if is_flexible {
    ...
    fn deserialize(version: crate::traits::ApiVersion, buf: &mut Bytes) -> Result<Self, SerializationError> {
        ...
        let results_by_transaction = if (4) <= version.0 {
            <Vec<AddPartitionsToTxnResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ResultsByTransaction"))?
        } else {
            Default::default()
        };
        let results_by_topic_v3_and_below = if (0) <= version.0 && version.0 <= (3) {
            <Vec<AddPartitionsToTxnTopicResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| SerializationError::Decode("failed to decode ResultsByTopicV3AndBelow"))?
        } else {
            Default::default()
        };
        Ok(Self { throttle_time_ms, error_code, results_by_transaction, results_by_topic_v3_and_below })
    }
}
impl KafkaSerialize for AddPartitionsToTxnResponse {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.results_by_transaction.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByTransaction".into() })?;
        self.results_by_topic_v3_and_below.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByTopicV3AndBelow".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.results_by_transaction.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByTransaction".into() })?;
        self.results_by_topic_v3_and_below.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByTopicV3AndBelow".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for AddPartitionsToTxnResponse {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let results_by_transaction = <Vec<AddPartitionsToTxnResult> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByTransaction".into() })?;
        let results_by_topic_v3_and_below = <Vec<AddPartitionsToTxnTopicResult> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByTopicV3AndBelow".into() })?;
        Ok(Self { throttle_time_ms, error_code, results_by_transaction, results_by_topic_v3_and_below })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let results_by_transaction = <Vec<AddPartitionsToTxnResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByTransaction".into() })?;
        let results_by_topic_v3_and_below = <Vec<AddPartitionsToTxnTopicResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByTopicV3AndBelow".into() })?;
        if is_flexible {
            // Tagged fields (skip)
...
impl KafkaSerialize for AddPartitionsToTxnPartitionResult {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.partition_error_code.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PartitionErrorCode".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.partition_error_code.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode PartitionErrorCode".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for AddPartitionsToTxnPartitionResult {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let partition_error_code = <i16 as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode PartitionErrorCode".into() })?;
        Ok(Self { partition_index, partition_error_code })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let partition_error_code = <i16 as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode PartitionErrorCode".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
...
impl KafkaSerialize for AddPartitionsToTxnResult {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.topic_results.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TopicResults".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        ...
        self.topic_results.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode TopicResults".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for AddPartitionsToTxnResult {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let topic_results = <Vec<AddPartitionsToTxnTopicResult> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode TopicResults".into() })?;
        Ok(Self { transactional_id, topic_results })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let topic_results = <Vec<AddPartitionsToTxnTopicResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode TopicResults".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
...
impl KafkaSerialize for AddPartitionsToTxnTopicResult {
    fn encode<B: BufMut>(&self, buf: &mut B) -> Result<(), EncodeError> {
        ...
        self.results_by_partition.encode(buf).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByPartition".into() })?;
        Ok(())
    }
    fn encode_flexible<B: BufMut>(&self, buf: &mut B, is_flexible: bool) -> Result<(), EncodeError> {
        self.name.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode Name".into() })?;
        self.results_by_partition.encode_flexible(buf, is_flexible).map_err(|_| EncodeError::ValueTooLarge { message: "failed to encode ResultsByPartition".into() })?;
        if is_flexible {
            // Tagged fields (none yet)
            crate::protocol::serialization::encode_unsigned_varint(0u64, buf);
        }
...
impl KafkaDeserialize for AddPartitionsToTxnTopicResult {
    fn decode<B: Buf>(buf: &mut B) -> Result<Self, DecodeError> {
        ...
        let results_by_partition = <Vec<AddPartitionsToTxnPartitionResult> as KafkaDeserialize>::decode(buf).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByPartition".into() })?;
        Ok(Self { name, results_by_partition })
    }
    fn decode_flexible<B: Buf>(buf: &mut B, is_flexible: bool) -> Result<Self, DecodeError> {
        ...
        let results_by_partition = <Vec<AddPartitionsToTxnPartitionResult> as KafkaDeserialize>::decode_flexible(buf, is_flexible).map_err(|_| DecodeError::Protocol { message: "failed to decode ResultsByPartition".into() })?;
        if is_flexible {
            // Tagged fields (skip)
            let (_tag_count, _) = crate::protocol::serialization::decode_unsigned_varint(buf)?;
        }
