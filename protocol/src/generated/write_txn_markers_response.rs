...
impl KafkaCodec for WriteTxnMarkersResponse {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for WritableTxnMarkerPartitionResult {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for WritableTxnMarkerResult {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
...
impl KafkaCodec for WritableTxnMarkerTopicResult {
    fn encode<B: BufMut>(
        &self,
        buf: &mut B,
        version: ApiVer,
