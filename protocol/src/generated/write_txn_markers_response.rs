...
impl ApiResponse for WriteTxnMarkersResponse {
    ...
    fn deserialize(
        ...
        let is_flexible = version.0 >= Self::get_min_flexible_version().0;
        let markers =
            <Vec<WritableTxnMarkerResult> as KafkaDeserialize>::decode(buf, version, is_flexible)
...
impl KafkaDeserialize for WritableTxnMarkerResult {
    fn decode<B: Buf>(
        ...
        let topics = <Vec<WritableTxnMarkerTopicResult> as KafkaDeserialize>::decode(
            buf,
            version,
            is_flexible,
        )
...
impl KafkaDeserialize for WritableTxnMarkerTopicResult {
    fn decode<B: Buf>(
        ...
        let partitions = <Vec<WritableTxnMarkerPartitionResult> as KafkaDeserialize>::decode(
            buf,
            version,
            is_flexible,
        )
